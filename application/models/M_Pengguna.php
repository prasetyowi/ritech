...
class M_Pengguna extends CI_Model
{
    ...
    public function Get_all_pengguna_by_id($pengguna_id)
    {
        ...
        $query = $this->db->query("SELECT
                                    ...
                                    IFNULL(karyawan_id, '')AS karyawan_id,
    ...
    public function Get_pengguna_by_filter($pengguna)
    {
        ...
        $query = $this->db->query("SELECT
                                    ...
                                    FROM pengguna a
                                    left join perusahaan b on b.perusahaan_id=a.pengguna_perusahaan
    ...
    public function insert_pengguna($pengguna_id, $pengguna_username, $pengguna_password, $pengguna_perusahaan, $karyawan_id, $add_by, $updwho, $updtgl, $is_aktif, $pengguna_email, $is_delete)
    {
    ...
    public function update_pengguna($pengguna_id, $pengguna_username, $pengguna_password, $pengguna_perusahaan, $karyawan_id, $add_by, $updwho, $updtgl, $is_aktif, $pengguna_email, $is_delete)
    {
        $pengguna_id = $pengguna_id == '' ? null : $pengguna_id;
        $pengguna_username = $pengguna_username == '' ? null : $pengguna_username;
        $pengguna_password = $pengguna_password == '' ? null : $pengguna_password;
