                        ...
                        <?php foreach ($Header as $value) : ?>
                            <div class="form-horizontal form-label-left">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control col-md-10" id="Quotation-nama_penawaran" name="Quotation[nama_penawaran]" value="<?= $value['nama_penawaran'] ?>" maxlength="250" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3 col-sm-3 ">Tanggal Quotation</label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="date" class="form-control col-md-10" id="Quotation-quotation_tanggal" name="Quotation[quotation_tanggal]" value="<?= $value['quotation_tanggal'] ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        ...
                                        <input type="hidden" class="form-control col-md-10" id="Quotation-customer_id" name="Quotation[customer_id]" value="<?= $value['customer_id'] ?>" disabled />
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <!-- <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control col-md-10" id="Quotation-jumlah" name="Quotation[jumlah]" value="" disabled />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3 col-sm-3 ">Waktu Pengiriman (Hari)</label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control col-md-10" id="Quotation-quotation_waktu_pengiriman" name="Quotation[quotation_waktu_pengiriman]" value="" disabled />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3 col-sm-3 ">Waktu Pengerjaan (Hari)</label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control col-md-10" id="Quotation-quotation_waktu_pengerjaan" name="Quotation[quotation_waktu_pengerjaan]" value="" disabled />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3 col-sm-3 ">Jumlah Termin Pembayaran</label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control col-md-10" id="Quotation-quotation_termin_pembayaran" name="Quotation[quotation_termin_pembayaran]" value="" disabled />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3 col-sm-3 ">Periode Penawaran</label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control col-md-10" id="Quotation-periode_penawaran" name="Quotation[periode_penawaran]" value="" disabled />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3 col-sm-3 ">Garansi</label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control col-md-10" id="Quotation-garansi" name="Quotation[garansi]" value="" disabled />
                                    </div>
                                </div> -->
                                <div class="form-group row">
                                            ...
                                            <tbody>
                                                <?php foreach ($Detail as $key2 => $value2) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-left"><?= $value2['barang_nama'] ?></td>
                                                        <td class="text-right"><?= $value2['qty'] ?></td>
                                                        <td class="text-left"><?= $value2['unit'] ?></td>
                                                        <td class="text-left"><?= $value2['remarks'] ?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
