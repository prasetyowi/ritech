                            ...
                            <div class="form-horizontal form-label-left">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-1 col-sm-1">
                                        <input type="checkbox" class="form-control col-md-12" id="Pembelian-is_ppn" value="1" <?= $value['is_ppn'] == '1' ? 'checked' : '' ?> disabled>
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <label class="control-label col-md-3 col-sm-3 ">PPh</label>
                                    <div class="col-md-1 col-sm-1">
                                        <input type="checkbox" class="form-control col-md-12" id="Pembelian-is_pph" value="1" <?= $value['is_pph'] == '1' ? 'checked' : '' ?> disabled>
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
