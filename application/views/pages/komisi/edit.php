                        ...
                        <div class="form-horizontal form-label-left">
                            <?php foreach ($Header as $value) : ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control col-md-12" id="Komisi-nama_project" name="Komisi[nama_project]" placeholder="Nama Project" value="<?= $value['nama_project'] ?>">
                                        <input type="hidden" class="form-control col-md-12" id="Komisi-komisi_tanggal" name="Komisi[komisi_tanggal]" value="<?= $value['nama_project'] ?>" required>
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="date" class="form-control col-md-12" id="Komisi-tanggal_pembayaran" name="Komisi[tanggal_pembayaran]" value="<?= $value['tanggal_pembayaran'] ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control col-md-12 mask-money text-right" id="Komisi-jumlah" name="Komisi[jumlah]" value="<?= format_rupiah($value['jumlah']) ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="form-group">
                                ...
                                <button class="btn btn-success" id="btn_update_komisi"><i class="fa fa-save"></i> Simpan</button>
                                <button class="btn btn-success" id="btn_konfirmasi_komisi"><i class="fa fa-check"></i> Konfirmasi</button>
                                <button class="btn btn-danger" id="btn_cancel_komisi"><i class="fa fa-times"></i> Batal</button>
                            </div>
                        </div>
                    </div>
                </div>
